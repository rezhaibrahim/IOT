...
<body>
    ...
    <li><a class="active" href="tampil_suhu.php"><b>Suhu</b></a></li>
...
<div class="col-sm-8 frame1">
	<center>
	<br>
	<font class="ukuran1">Kondisi Suhu Pada Udara</font>
	<br>
	<br>
	<table	width=50%>
		<?php
		...
		?>
		<tr>
		<td width=32%><div class="hsuhu"><center>Suhu</center></div></td>
		</tr>
		
		<tr>
		<td width=32%><div class="bsuhu"><center><?php echo $x['suhu']; ?>&#176;C</center></div></td>
		</tr>
