...
<body>
    ...
    <li><a class="active" href="tampil_kualitas.php"><b>Kualitas Udara</b></a></li>
...
<div class="col-sm-8 frame1">
	<center>
	<br>
	<font class="ukuran1">Kualitas Pada Udara</font>
	<br>
	<br>
	<table	width=50%>
		<?php
		...
		?>
		<tr>
		<td width=32%><div class="hsuhu"><center>Kualitas Udara</center></div></td>
		</tr>
		
		<tr>
		<td width=32%><div class="bsuhu"><center><?php echo $x['kualitasudara']; ?>&#176;C</center></div></td>
		</tr>
