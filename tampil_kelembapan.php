...
<body>
    ...
    <li><a class="active" href="tampil_kelembapan.php"><b>Kelembapan</b></a></li>
...
<div class="col-sm-8 frame1">
	<center>
	<br>
	<font class="ukuran1">Kondisi Kelembapan Pada Udara</font>
	<br>
	<br>
	<table width=50%>
		<?php
		...
		?>
		<tr>
		<td><div class="htinggi"><center>Kelembapan Udara</center></div></td>
		</tr>
		
		<tr>
		<td width=32%><div class="btinggi"><center><?php echo $x['kelembapan']; ?> m</center></div></td>
		</tr>
...
<div class="row">
  ...
  <div class="col-sm-8">
	<center>
    <table class="table table-striped table-bordered table-hover display" id="example" width=70%>
      <thead>
        <tr>
          <th>No.</th>
		  <th>Tanggal </th>
	...
	<tr>
		...
		<td><?php echo $x['tinggicairan']; ?> m</td>
	</tr>
	<?php 
	}
	?>
